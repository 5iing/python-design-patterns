...
- **[코드 보기](creational/singleton_pattern.py)**

### 팩토리 패턴

![Factory Pattern](.diagram/factory.png)

- **특징**: 객체 생성 과정을 별도의 클래스로 분리
- **장점**: 객체 생성과 사용이 명확하게 분리되어 확장이나 변경이 쉬움
- **단점**: 클래스가 많아지고 구조가 복잡해질 수 있음
- **사용 사례**: 여러 타입의 객체가 필요한 상황
- **[코드 보기](creational/factory_pattern.py)**

### 추상 팩토리 패턴

![Abstract Factory Pattern](.diagram/abstract_factory.png)
...
- **[코드 보기](creational/abstract_factory_pattern.py)**
...
- **[코드 보기](structual/bridge_pattern.py)**

### 컴포지트 패턴

![Composite Pattern](.diagram/composite.png)
...
- **[코드 보기](structual/composite_pattern.py)**

### 데코레이터 패턴

![Decorator Pattern](.diagram/decorator.png)
...
- **[코드 보기](structual/decorator_pattern.py)**
...
- **[코드 보기](structual/facade_pattern.py)**

### 플라이웨이트 패턴

![Flyweight Pattern](.diagram/flyweight.png)

- **특징**: 공통된 데이터를 공유해 메모리 사용을 줄임
- **장점**: 메모리 절약 효과가 크고 성능이 향상될 수 있음
- **단점**: 코드가 복잡해지고 공유하지 않는 속성 관리가 까다로움
- **사용 사례**: 텍스트 에디터 게임 엔진의 오브젝트 관리
- **[코드 보기](structual/flyweight_pattern.py)**

### 프록시 패턴

![Proxy Pattern](.diagram/proxy.png)

- **특징**: 실제 객체에 대한 접근을 제어
- **장점**: 지연 로딩 접근 권한 관리 캐싱 등 다양한 용도에 활용
- **단점**: 응답 시간이 길어질 수 있고 구조가 더 복잡해짐
- **사용 사례**: 가상 프록시 보안 프록시 원격 프록시 등
- **[코드 보기](structual/proxy_pattern.py)**

## Behavioral Patterns (행동 패턴)

### Chain of Responsibility 패턴

![Chain of Responsibility Pattern](.diagram/chain_of_responsiblity.png)
...
- **[코드 보기](behavioral/chan_of_responsiblity_pattern.py)**

### Command 패턴

![Command Pattern](.diagram/command.png)
...
- **[코드 보기](behavioral/command_pattern.py)**

### Iterator 패턴

![Iterator Pattern](.diagram/iterator.png)
...
- **[코드 보기](behavioral/iterator_pattern.py)**

### Mediator 패턴

![Mediator Pattern](.diagram/mediator.png)
...
- **[코드 보기](behavioral/mediator_pattern.py)**
...
- **[코드 보기](behavioral/memento_pattern.py)**

### Observer 패턴

![Observer Pattern](.diagram/observer.png)
...
- **[코드 보기](behavioral/observer_pattern.py)**

### State 패턴

![State Pattern](.diagram/state.png)
...
- **[코드 보기](behavioral/state_pattern.py)**
...
- **[코드 보기](behavioral/strategy_pattern.py)**
...
- **[코드 보기](behavioral/visitor_pattern.py)**

### Template method 패턴

![Template Method Pattern](.diagram/template_method.png)
...
- **[코드 보기](behavioral/template_method_pattern.py)**
